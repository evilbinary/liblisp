...
To use LW-ADD-ONS you need ASDF, LW-DOC, and a recent version of
LispWorks:
...
*ASDF-PATHNAME*, *ASDF-DIRS*, and *WORKING-DIR* to fit your local
settings.  Specifically, make sure that LW-ADD-ONS, LW-DOC and their
supporting libraries can be found via *ASDF-DIRS*.
...
loading of initialization files.  You'll have to use a workaround like
